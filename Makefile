...
PROJECT_REPO ?= github.com/fujin/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 3.8.6
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-netbox
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-netbox.3.8.6
